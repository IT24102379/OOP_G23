...
<div class="form-container">
  ...
  <form action="${pageContext.request.contextPath}/MovieUpdateServlet" method="post" onsubmit="return validateForm()">
    ...
    <div class="form-group">
      ...
      <input type="text" id="imageLink" name="imageLink" value="${movie.imageLink}" placeholder="/images/movie1.jpg">
    </div>
    <div class="form-group">
  ...
  <a href="${pageContext.request.contextPath}/MovieListServlet" class="back-link">Back to Movie List</a>
</div>
</body>
</html>